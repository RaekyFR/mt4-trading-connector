                ...
                <div class="p-strip">
                    <div class="row">
                        ...
                        <div class="col-6 u-align--right">
                            <button class="p-button--negative" id="closeAllOrdersBtn">Tout Fermer</button>
        ...
        try {
            ...
            const html = `
                <div class="p-strip">
                    <div class="row">
                        <div class="col-8">
                            <h1 class="p-heading--2">Gestion des Risques</h1>
                        </div>
        ...
        try {
            ...
            const html = `
                <div class="p-strip">
                    <div class="row">
                        <div class="col-8">
                            <h1 class="p-heading--2">Historique d'Audit</h1>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="p-card">
                            ...
                            <div class="p-card__content">
                                ...
                                <div class="u-align--right">
                                    <button class="p-button--base is-dense" onclick="editStrategy('${strategy.id}')">Modifier</button>
                        ...
                        <tbody>
                            ${signals.map(signal => `
                                <tr>
                                    ...
                                    <td>${signal.symbol}</td>
                                    <td>${signal.price ? window.api.formatCurrency(signal.price) : 'Marché'}</td>
                                    <td><span class="p-label--information">${statusLabels[signal.status] || signal.status}</span></td>
                                    <td>
            ...
            <div class="p-modal" id="strategyModal" style="display: block;">
                <div class="p-modal__dialog">
                    <div class="p-modal__header">
                        ...
                        <button class="p-modal__close" onclick="closeModal('strategyModal')">Fermer</button>
                    </div>
                    <div class="p-form-validation">
                        <div class="p-form-validation__field">
